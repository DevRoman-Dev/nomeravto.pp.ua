...
import { t as TI } from "../_libs/satori.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-QOPOQVf0.js
...
var $$splitComponentImporter$4 = () => import("./nomer._plate-DFm_Y-us.mjs");
...
var $$splitComponentImporter$3 = () => import("./region._code-fFZNcrbI.mjs");
...
var $$splitComponentImporter$1 = () => import("./ru.nomer._plate-w1AGDrLj.mjs");
...
var $$splitComponentImporter = () => import("./ru.region._code-CKt3-6Cw.mjs");
...
async function getFontData() {
	if (!fontData) fontData = await (await fetch("https://github.com/google/fonts/raw/main/apache/roboto/Roboto-Bold.ttf")).arrayBuffer();
	return fontData;
}
var Route = createFileRoute("/api/og/plate/$plate")({ server: { handlers: { GET: async ({ params }) => {
	...
	const svg = await TI(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		style: {
			display: "flex",
			width: "100%",
			height: "100%",
	...
	const pngBuffer = new Resvg(svg, { background: "rgba(238, 235, 230, .9)" }).render().asPng();
