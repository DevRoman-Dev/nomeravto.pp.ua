...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BjcKJcga.mjs");
...
var manifest = { "be0e8dff2537fdafc6d7c5a8f32e5549aa63360e15e9599fde34320d0f8589e1": {
	...
	importer: () => import("./plate-lookup.functions-DpaOuYqs.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BxkBg7Hk.mjs").then((n) => n.t),
		import("./start-B2ymfMuz.mjs"),
